...
export function Modal({
  ...
  return createPortal(
    <dialog
      ...
      className={`bg-ehs-surface backdrop:bg-ehs-overlay fixed top-1/2 left-1/2 z-[200] w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-2xl border-0 p-0 shadow-(--ehs-shadow-modal) backdrop:backdrop-blur-[2px] open:flex open:flex-col ${SIZE_CLASS[size]} ${className}`.trim()}
    >
