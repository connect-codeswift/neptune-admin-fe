...
export function Modal({
  ...
  return createPortal(
    <dialog
      ...
      className={`fixed top-1/2 left-1/2 z-50 w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border-0 bg-white p-0 shadow-[0_20px_50px_rgba(15,23,42,0.2)] backdrop:bg-darkest/50 open:flex open:flex-col ${SIZE_CLASS[size]} ${className}`.trim()}
    >
