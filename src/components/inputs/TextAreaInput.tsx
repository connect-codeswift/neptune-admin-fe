  ...
  return (
    <div className={`flex flex-col gap-1.5 ${containerClassName}`.trim()}>
      ...
      <textarea
        ...
        className={`w-full resize-y rounded-[10px] border bg-white px-3.5 py-3 text5 text-darkest shadow-lg outline-none transition-colors placeholder:text-darkest/50 focus-visible:ring-2 disabled:cursor-not-allowed disabled:bg-lightgray disabled:opacity-60 ${
          error
