    ...
    <div className={`flex flex-col gap-1.5 ${containerClassName}`.trim()}>
      ...
      <div className="relative">
        <Icon
          ...
          width={20}
          height={20}
          className="pointer-events-none absolute top-1/2 left-3.5 -translate-y-1/2 text-ehs-muted-text"
          aria-hidden
        />
        <input
          id={inputId}
          ...
          className={`h-12 w-full rounded-2.5 border bg-ehs-surface/55 py-0 pr-3.5 pl-10 text4 text-ehs-darker backdrop-blur-1.25 outline-none transition placeholder:text-ehs-muted-text aria-invalid:border-ehs-red aria-invalid:focus:border-ehs-red aria-invalid:focus:ring-ehs-red/15 disabled:cursor-not-allowed disabled:opacity-60 [&::-webkit-search-cancel-button]:appearance-none ${
            error
