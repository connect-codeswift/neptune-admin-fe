...
export function MultiBadgesInput({
  ...
  return (
    <div className={`flex flex-col gap-1.5 ${containerClassName}`.trim()}>
      ...
      <div
        className={`flex min-h-12 w-full flex-wrap items-center gap-1.5 rounded-[10px] border bg-white px-3 py-2 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-colors focus-within:ring-2 ${
          error
